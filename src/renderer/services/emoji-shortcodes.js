/**
 * Emoji shortcode map: shortcode name (without colons) → unicode emoji.
...
const EMOJI_SHORTCODES = {
  ...
  "worried": "😟", "frowning": "☹️", "anguished": "😧", "open_mouth": "😮",
  ...
  "person_frowning": "🙍", "bow": "🙇", "couplekiss": "💏",
  "couple_with_heart": "💑", "massage": "💆", "haircut": "💇",
  "nail_care": "💅", "boy": "👦", "girl": "👧", "woman": "👩", "man": "👨",
  "baby": "👶", "older_woman": "👵", "older_man": "👴",
  "person_with_blond_hair": "👱", "man_with_gua_pi_mao": "👲",
  "man_with_turban": "👳", "construction_worker": "👷", "cop": "👮",
  ...
  "kiss": "💋", "droplet": "💧", "ear": "👂", "eyes": "👀", "nose": "👃",
  "tongue": "👅", "love_letter": "💌", "bust_in_silhouette": "👤",
  "busts_in_silhouette": "👥", "speech_balloon": "💬",
  "thought_balloon": "💭", "sunny": "☀️", "umbrella": "☔", "cloud": "☁️",
  "snowflake": "❄️", "snowman": "⛄", "zap": "⚡", "cyclone": "🌀",
  "foggy": "🌁", "ocean": "🌊", "cat": "🐱", "dog": "🐶", "mouse": "🐭",
  ...
  "bug": "🐛", "honeybee": "🐝", "ant": "🐜", "beetle": "🐞",
  "snail": "🐌", "octopus": "🐙", "tropical_fish": "🐠", "fish": "🐟",
  "whale": "🐳", "whale2": "🐋", "dolphin": "🐬", "cow2": "🐄",
  "ram": "🐏", "rat": "🐀", "water_buffalo": "🐃", "tiger2": "🐅",
  "rabbit2": "🐇", "dragon": "🐉", "goat": "🐐", "rooster": "🐓",
  "dog2": "🐕", "pig2": "🐖", "mouse2": "🐁", "ox": "🐂",
  ...
  "first_quarter_moon_with_face": "🌛", "moon": "🌔",
  ...
  "dvd": "📀", "floppy_disk": "💾", "camera": "📷",
  "video_camera": "📹", "movie_camera": "🎥", "computer": "💻", "tv": "📺",
  "iphone": "📱", "phone": "☎️", "telephone": "📞",
  ...
  "mailbox_with_mail": "📬", "mailbox_with_no_mail": "📭", "door": "🚪",
  "smoking": "🚬", "bomb": "💣", "gun": "🔫", "hocho": "🔪", "pill": "💊",
  ...
  "mountain_bicyclist": "🚵", "bicyclist": "🚴", "horse_racing": "🏇",
  "snowboarder": "🏂", "swimmer": "🏊", "surfer": "🏄",
  ...
  "game_die": "🎲", "dart": "🎯", "mahjong": "🀄", "clapper": "🎬",
  "memo": "📝", "pencil": "✏️", "book": "📖", "art": "🎨",
  ...
  "beginner": "🔰", "atm": "🏧", "slot_machine": "🎰", "busstop": "🚏",
  "barber": "💈", "hotsprings": "♨️", "checkered_flag": "🏁",
  "crossed_flags": "🎌", "izakaya_lantern": "🏮", "moyai": "🗿",
  ...
  "keycap_ten": "🔟", "zero": "0️⃣", "hash": "#️⃣",
  "arrow_backward": "◀️", "arrow_down": "⬇️", "arrow_forward": "▶️",
  "arrow_left": "⬅️", "arrow_lower_left": "↙️",
  "arrow_lower_right": "↘️", "arrow_right": "➡️", "arrow_up": "⬆️",
  "arrow_upper_left": "↖️", "arrow_upper_right": "↗️",
  "arrow_down_small": "🔽", "leftwards_arrow_with_hook": "↩️",
  ...
  "repeat_one": "🔂", "new": "🆕", "top": "🔝", "up": "🆙", "cool": "🆒",
  "free": "🆓", "ng": "🆖", "cinema": "🎦", "signal_strength": "📶",
  "restroom": "🚻", "mens": "🚹", "womens": "🚺", "baby_symbol": "🚼",
  "no_smoking": "🚭", "parking": "🅿️", "wheelchair": "♿", "metro": "🚇",
  "baggage_claim": "🛄", "accept": "🉑", "wc": "🚾",
  "potable_water": "🚰", "put_litter_in_its_place": "🚮",
  "secret": "㊙️", "congratulations": "㊗️", "passport_control": "🛂",
  "left_luggage": "🛅", "customs": "🛃", "ideograph_advantage": "🉐",
  "cl": "🆑", "sos": "🆘", "id": "🆔", "no_entry_sign": "🚫",
  "underage": "🔞", "no_mobile_phones": "📵", "do_not_litter": "🚯",
  "non_potable_water": "🚱", "no_bicycles": "🚳",
  "no_pedestrians": "🚷", "children_crossing": "🚸", "no_entry": "⛔",
  "eight_spoked_asterisk": "✳️", "eight_pointed_black_star": "✴️",
  "heart_decoration": "💟", "vs": "🆚", "vibration_mode": "📳",
  "mobile_phone_off": "📴", "chart": "💹", "currency_exchange": "💱",
  ...
  "clock11": "🕚", "clock1130": "🕦", "clock12": "🕛", "clock1230": "🕧",
...
/**
 * Pre-built sorted array of [shortcode, emoji] for fast prefix search.
 * @type {[string, string][]}
 */
const SORTED_ENTRIES = Object.entries(EMOJI_SHORTCODES).sort((a, b) => a[0].localeCompare(b[0]));

/**
 * @param {string} query
 * @param {number} [limit=10]
 * @returns {{shortcode: string, emoji: string}[]}
 */
export function searchEmoji(query, limit = 10) {
  const q = query.toLowerCase();
  const results = [];
  for (const [shortcode, emoji] of SORTED_ENTRIES) {
  ...
  if (results.length < limit) {
    for (const [shortcode, emoji] of SORTED_ENTRIES) {
      if (!shortcode.startsWith(q) && shortcode.includes(q)) {
        results.push({ shortcode, emoji });
        if (results.length >= limit) break;
      }
    }
 ...
 */
export function getEmoji(shortcode) {
  return EMOJI_SHORTCODES[shortcode];
}
